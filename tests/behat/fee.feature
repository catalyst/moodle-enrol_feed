@enrol @enrol_feed
Feature: Signing up for a course with a feed enrolment method
  ...
  Background:
    ...
    And I click on "Enable" "link" in the "Enrolment on payment with account creation" "table_row"
    And I log out
  ...
  Scenario: Student can see the payment prompt on the course enrolment page
    ...
    And I select "Enrolment on payment with account creation" from the "Add method" singleselect
