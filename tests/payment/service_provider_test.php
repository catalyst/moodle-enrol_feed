...
class service_provider_testcase extends \advanced_testcase {
    ...
    public function test_get_payable() {
        ...
        $feeplugin = enrol_get_plugin('feed');
        ...
        $payable = service_provider::get_payable('feed', $id);
    ...
    public function test_get_success_url() {
        ...
        $successurl = service_provider::get_success_url('feed', $id);
        $this->assertEquals(
    ...
    public function test_deliver_order() {
        ...
        service_provider::deliver_order('feed', $id, $paymentid, $user->id);
