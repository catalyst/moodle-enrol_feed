...
/**
 * Strings for component 'enrol_feed', language 'en'
 *
 * @package    enrol_feed
...
$string['feed:config'] = 'Configure enrolment on payment enrol instances';
$string['feed:manage'] = 'Manage enrolled users';
$string['feed:unenrol'] = 'Unenrol users from course';
$string['feed:unenrolself'] = 'Unenrol self from course';
...
$string['pluginname'] = 'Enrolment on payment with account creation';
