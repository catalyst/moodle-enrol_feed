...
/**
 * Privacy Subsystem implementation for enrol_feed.
 *
 * @package    enrol_feed
 * @category   privacy
...
/**
 * Privacy Subsystem for enrol_feed implementing null_provider.
 *
 * @copyright  2020 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
    ...
    \core_payment\privacy\consumer_provider
{
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        $subcontext = [
            get_string('pluginname', 'enrol_feed'),
        ];
        foreach ($contextlist as $context) {
            if (!$context instanceof \context_course) {
                continue;
            }
            $feeplugins = $DB->get_records('enrol', ['courseid' => $context->instanceid, 'enrol' => 'feed']);
